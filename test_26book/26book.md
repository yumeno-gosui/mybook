...
出目が、1〜2 | 判定失敗 | 手がかりなし | 判定に使用した能力値を減らす | 手がかりを1つ忘れる

出目が、3〜4 | 悪ふざけ |手がかりなし | 判定に使用した能力値を減らす

出目が、 5〜9 | 判定成功 | 手がかりを1つ得る

出目が、  10以上 | 判定大成功 | 手がかりを2つ得る
...
| 10 | [オーケストラの楽器] - 物語に落ち着かせる声がなんだったのかを加えること |
...
[ショッピングセンター] - 大小様々なテナントが入っているが、サブカルの聖地とも呼ばれている。地下は食料品、1階は日用品、2階〜4階はサブカル系オタク・マニア向け店舗が多い。
...
ソロで遊ぶ場合と、複数人で遊ぶ場合ではプレイに対する考え方が違ってくることになります。