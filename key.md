...
## TTRPGとは? 
TTRPG(テーブルトップ・ロールプレイング・ゲーム)とは、1人または複数の友人がキャラクターを作成し、そのキャラクターを操作して、冒険をしながら物語を共有する遊びです。

多くの場合、TTRPGでは、プレイヤーの1人がガイド(通常、ゲームマスターまたはGMと呼ばれる)として、ゲームの語り手や審判の役割を果たす必要があります。<br>
また、GMはゲームの架空の設定や冒険の目標を作成する役割も担います。

とはいえ、GMレスプレイやソロプレイではGMの役割をプレイヤー間で均等に分担したり、サイコロを振ったりカードを引いたりといったランダムに発生するプロンプトで代用したりすることも可能です。 

いずれにせよ、TTRPGではプレイヤーキャラクター（PC）の行動と選択によって冒険の行方が形作られます。PCには様々な属性や技能があり、それらは通常数値で割り当てられ、経歴や職業に結びつきます。

ゲーム中、プレイヤーは自分のキャラクターに何をさせたいかを記述し、その行動の成否は通常ダイスを振って決定する。多くのTTRPGでは、プレイヤーはゲーム内の状況やキャラクターの属性や技能によって、結果を加減することもできます。
