...
例えば、そのアクションを行おうとしているPCが助けを得ていたり、便利なアイテムを装備していたりする場合は簡単で、気を取られていたり、体調が悪かったりする場合は難しいかもしれません。より簡単な場合、そのアクションはアドバンテージで実行でき、より困難な場合、ディスアドバンテージで実行できる。
...
### コンディション 
コンディションとは、特定の状況においてPCに適用される効果であり、有害であったり有益であったり、機械的効果や物語的効果を持つ。

以下は推奨されるコンディションのリストであり、必要に応じて追加や修正が可能である。
 
[活性化］
PCは活性化され、次の休息までに使用可能なボーナスEPを一時的に1d6分得る。
 
[阻害]
PCの動きがより困難になるか、部分的に拘束される。阻害が解除されるまでの間、阻害の影響を受けた行動はディスアドバンテージを被る。
