...
オプションルールとして、緊張感を高めるためにも“タイトスポット中はすべてのキャラクターのアクションを運ロールとして行わなければならない”と指定することもできます。
...
#### 戦闘による損害(オプション) 
PCがゲーム内で誰かに重傷を負わせたり殺したりするたびに、そのPCの**《社交性》**プールの最大値が-1される。
...
### 休息 
キャラクターは休息することで、能力値プールにEPを回復させることができます。休息はゲーム内で過ごす1日の終わりに行うか、GMやプレイヤーが適切だと思うときに行うことができます。
休息する際は各プレイヤーが1D6して、その出目を能力値プールに割り振ります。回復量は最大値を超えることはありません。

### 成長 
1つ以上の冒険やゲームセッションを成功させた後、キャラクターは以下の2つの方法のいずれかで成長することができます。
 
#### 1. 能力値の最大値を増やす。
プレイヤーは1d6を振り、その結果をキャラクターの能力値に配分し、EPの最大値を増やす。アドベンチャーの最中に、プレイヤーが魅力的なロールプレイを見せたり、面白いジョークを言ったりした場合、グループの他のプレイヤーはそのプレイヤーの成長を1d6追加することができます。
 
#### 2. 新たな技能を習得する。
プレイヤーは新たな技能1つ、および/または不得意1つを追加、または置き換えることができる。これらはゲーム中の出来事と矛盾しない内容であることが必須です。
 
ゲームの設定やテーマによっては、さらに成長オプションを追加することも可能です(例えば、新たな物語上の資産や特性を得るなど)。
 
 
## ファンタスティック（オプション） 
あなたのゲームに魔法や奇妙な異星人の技術や超能力のようなものが組み込まれている場合、あなたはそれらをメカニズム的および／または物語的に含めるために、以下の提案された方法のいずれかを使用することができます。
 
### 技能としてのファンタスティック 
ゲームのファンタスティカル要素を、キャラクターが習得可能なスキルにします。呪文を唱える、エイリアンの装置を操作する、ヒートビジョンを使うなど、ファンタスティカルは訓練と経験を必要とするものであり、成長中に習得できます。 

もちろん、そのようなスキルの有無や利用しやすさはあなた次第であり、ゲームの設定に依存します。
 
### 特性としてのファンタスティック 
ゲームのファンタスティック要素を特性として、キャラクターが自分の種族や民族のおかげで生得的に利用できるよういします。キャラクターは生まれながらにして魔法の使い手であったり、異星人の一員であったり、青年期に自然発生的に超能力を身につけたりもします。 
 
### 技能および特性としてのファンタスティック 
ゲームのファンタスティカル要素を、PCが生まれながらにして使えるが、使いこなすには練習と経験が必要なものにする、という複合的なアプローチを試してみましょう。
あなたのゲームにおけるソーサラーは、生まれながらにして魔法に縁があるかもしれませんが、訓練なしに呪文を唱えようとすると悲惨な結果を招く危険があります。
 
どのようなアプローチをとるにせよ、あらかじめ用意されたファンタジーの要素（例：呪文、テクノロジー、スーパーパワーなど）をリストアップしておき、その中からプレイヤーが選択できるようにしましょう。あるいは、ロール表やプロンプト（10ページ参照）を使って、プレイヤー自身に創作させることもできます。
